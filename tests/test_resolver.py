...
from mixology import DependencyGraph
from mixology import Resolver
from mixology.exceptions import CircularDependencyError
from mixology.exceptions import ResolverError
from mixology.exceptions import VersionConflict
...
class Case:
    ...
    def add_dependencies_to_graph(self, graph, parent, data, all_parents=None):
        ...
        name = data['name']
        version = Version.coerce(data['version'])
